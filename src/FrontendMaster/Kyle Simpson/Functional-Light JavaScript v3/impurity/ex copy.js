...
function getStudentsByID(curStudents) {
  var orignStudents = students.slice()
  var newStudents = sortStudentsByID()
  students = orignStudents
  return newStudents
  // console.log(curStudents);
  // console.log(typeof curStudents);
  // var orignStudents = curStudents.slice(0)
  var newStudents = getStudentsByID()
